    ...
    "Benchmark": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "bf341bd71b2cce0506679e5a1b940efefb44fcbb",
          "message": "chore(deps): add Dependabot config for cargo ecosystem\n\nConfigure Dependabot to open weekly PRs for outdated Cargo\ndependencies found in the root workspace.",
          "timestamp": "2026-06-14T12:31:28+03:00",
          "tree_id": "0e8df39f2e181f3f2d1a1fbb340303937815de82",
          "url": "https://github.com/murenkov/raznoor.rs/commit/bf341bd71b2cce0506679e5a1b940efefb44fcbb"
        },
        "date": 1781430107985,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "35d149683ee0efbc6012464769fdcf116ea1f571",
          "message": "fix(irk): correct RADAU_IIA_5 Butcher tableau to satisfy row-sum condition to machine precision\n\nReplaced A, b, c decimal literals with values computed from the exact\nrational expressions in Hairer & Wanner (also listed on Wikipedia for\nRadau IIA methods). The previous A-matrix entries introduced rounding\nerrors up to 3.7e-9, breaking the RK consistency condition c = A*1.\n\nKey changes:\n- A[0][0]: 0.1968154735226860 -> 0.19681547722366044\n- A[0][1]: -0.0655354258501656 -> -0.06553542585019838\n- A[1][*]: minor precision improvements\n- A[2][0]: 0.3764030626994664 -> 0.37640306270046725\n- doc-test b-sum tolerance: 1e-11 -> 1e-15",
          "timestamp": "2026-06-14T12:53:32+03:00",
          "tree_id": "df75dd327e4b003e4b200197075d6b2cfc61aa4b",
          "url": "https://github.com/murenkov/raznoor.rs/commit/35d149683ee0efbc6012464769fdcf116ea1f571"
        },
        "date": 1781431416033,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "6cd0e3f5ddc2e0c70cbabb47efa834074c17784f",
          "message": "docs: fix ODEMethod example return type in README\n\nThe Extensibility section showed step_with_scratch returning a single\n`Array1<T>`, but the trait signature returns `(Array1<T>, Array1<T>)`.\nUpdated the example to return a tuple `(u_new, du_new)` where `du_new`\nis the derivative at the new time point, matching the real\nimplementations (e.g., src/erk.rs:291-308).",
          "timestamp": "2026-06-14T13:12:31+03:00",
          "tree_id": "41e28791fbee18ae6585de9589460d55fb6b5624",
          "url": "https://github.com/murenkov/raznoor.rs/commit/6cd0e3f5ddc2e0c70cbabb47efa834074c17784f"
        },
        "date": 1781432569262,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "fbef8ebaba56f3a344226afe9bad3711daaf0b79",
          "message": "feat(api)!: replace panicking asserts with Result returns for interpolation\n\nReplace all panicking `assert!` calls in `ODESolution::interpolate`,\n`ODESolution::interpolate_many`, `HermiteInterpolant::new`,\n`HermiteInterpolant::call`, and `HermiteInterpolant::call_many` with\n`Result` returns using new `SolverError` variants.\n\nChanges:\n- Add `SolverError::InterpolationOutOfRange` variant for out-of-range\n  time inputs\n- Add `SolverError::MissingDerivativeData` variant for missing\n  derivative data (previously `Option::None`)\n- Add `SolverError::InvalidInterpolationData` variant for invalid\n  `HermiteInterpolant::new` arguments (previously panics)\n- `ODESolution::interpolate` returns `Result<Array1<T>, SolverError>`\n  instead of `Option<Array1<T>>`\n- `ODESolution::interpolate_many` returns `Result<Array2<T>, SolverError>`\n  instead of `Option<Array2<T>>`\n- `DenseOutput::call` returns `Result<Array1<T>, SolverError>` instead\n  of `Array1<T>`\n- `DenseOutput::call_many` returns `Result<Array2<T>, SolverError>`\n  instead of `Array2<T>`\n- `HermiteInterpolant::new` returns `Result<Self, SolverError>` instead\n  of `Self`\n- Update all unit and integration tests accordingly",
          "timestamp": "2026-06-14T13:25:08+03:00",
          "tree_id": "f007be1dfe907224e7b40ecd3630b17ff9071b90",
          "url": "https://github.com/murenkov/raznoor.rs/commit/fbef8ebaba56f3a344226afe9bad3711daaf0b79"
        },
        "date": 1781433320811,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "19895f1156a584c2aa5e04a5eb91cd2361d06905",
          "message": "refactor(types): replace derive(PartialEq) with manual impl for SolverError\n\nDeriving PartialEq works for unit variants, but will fail to compile if any variant is later changed to carry data (e.g. floats or indices).\n\nReplace the derive with a manual impl PartialEq using core::mem::discriminant so that adding data to any variant will not break the build. The behaviour is identical for unit variants.",
          "timestamp": "2026-06-14T13:38:51+03:00",
          "tree_id": "9e6b487de3beaebf7735ed642a0e9fdf42b8a3cb",
          "url": "https://github.com/murenkov/raznoor.rs/commit/19895f1156a584c2aa5e04a5eb91cd2361d06905"
        },
        "date": 1781434145086,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "35a2c965e047cee5f4e4cb5833d7efe1baf59c86",
          "message": "refactor: consolidate duplicated Hermite interpolation into a single shared function\n\nMove the cubic Hermite interpolation arithmetic from `HermiteInterpolant::interpolate`\nand `ODESolution::hermite_eval` into a shared `pub(crate)` associated function\n`HermiteInterpolant::eval_cubic_hermite`. Both callers now delegate to it with\nborrowed data, eliminating the code duplication.\n\n`ODESolution` methods (`interpolate`, `interpolate_many`) remain functionally\nidentical -- they now delegate through `hermite_eval` which calls\n`HermiteInterpolant::eval_cubic_hermite` with `&self.t`, `&self.u`, and `du`.\nThe private `HermiteInterpolant::interpolate` likewise delegates with its owned\n`&self.t`, `&self.y`, `&self.dy`.",
          "timestamp": "2026-06-15T19:15:41+03:00",
          "tree_id": "c2f12a262860224fe014dcc717519080128e483e",
          "url": "https://github.com/murenkov/raznoor.rs/commit/35a2c965e047cee5f4e4cb5833d7efe1baf59c86"
        },
        "date": 1781540751087,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "5a92d6a972c0d43735296df7a31cff9b3064528a",
          "message": "perf(bdf): replace Vec with VecDeque in history ring buffer\n\nReplace `Vec<Array1<T>>` with `VecDeque<Array1<T>>` for the\n`BDFScratch::history` field so that dropping the oldest state\nuses O(1) `pop_front` instead of O(n) `remove(0)`.\n\nAlso tighten the capacity check from `>` to `>=` so the buffer\nstays at exactly `max_history` entries rather than growing one\nelement oversized before trimming.",
          "timestamp": "2026-06-15T19:36:07+03:00",
          "tree_id": "03f7607a416b029e3eacacafcef6d364fd68a816",
          "url": "https://github.com/murenkov/raznoor.rs/commit/5a92d6a972c0d43735296df7a31cff9b3064528a"
        },
        "date": 1781541994743,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "d549abb042f41b827c841e1eb79d728f622a5852",
          "message": "test: add Newton convergence failure / Picard fallback tests\n\nExercise the Picard fixed-point fallback path in both IRK\n(irk.rs:332-358) and BDF (bdf.rs:313-332) step functions.\n\nThe test uses a nonlinear cubic problem with aggressive step size,\ncausing the simplified Newton iteration to stall. With a frozen\nJacobian the Newton residual oscillates above 1e-12 for 15\niterations, triggering the fallback to Picard iteration.\n\nBoth tests verify the solver completes without error and produces\na finite result.",
          "timestamp": "2026-06-15T19:52:40+03:00",
          "tree_id": "722fed28eaff4c793ee47923679933e51bb66a8c",
          "url": "https://github.com/murenkov/raznoor.rs/commit/d549abb042f41b827c841e1eb79d728f622a5852"
        },
        "date": 1781542976284,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "0cd07f53d7e83ded4e01179cf41b92a4d2a0ca63",
          "message": "feat(linalg): accept `h` parameter in `compute_jacobian` for scale-aware step\n\nReplace the hard-coded step `h = 1e-6` with a caller-provided `h` parameter\nso that the finite-difference step can be adapted to the magnitude of state\nvariables. Both call sites (`irk.rs`, `bdf.rs`) now compute a scale-aware\nstep `h = 1e-8 * max(1, ||u||_inf)` before calling.",
          "timestamp": "2026-06-15T20:05:25+03:00",
          "tree_id": "d52f95d840dd5b4daaad6f1c3e222d96370f74df",
          "url": "https://github.com/murenkov/raznoor.rs/commit/0cd07f53d7e83ded4e01179cf41b92a4d2a0ca63"
        },
        "date": 1781543750593,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "bd55fe09420daa4e7826348f6351c2d93cb3c991",
          "message": "ci: add cargo-machete and cargo-udeps to audit unused dependencies\n\nAdd two dependency-auditing tools to CI and pre-commit:\n\n- `cargo-machete` (stable): checks that every declared `[dependencies]`\n  entry is actually imported in code. Added to both CI and pre-commit.\n- `cargo-udeps` (nightly): detects unused transitive dependencies at\n  the crate level for production builds (`--lib --bins`). Added as a\n  separate CI job using `taiki-e/install-action` for pre-built binaries.\n\nUpdate CONTRIBUTING.md to document both checks alongside existing CI\nsteps. Dev-only transitive deps (pulled by `criterion`/`proptest` via\n`wasm-bindgen`, `wit-bindgen`, `wasmparser`, `plotters`) are expected\nto remain in the lockfile and are not flagged by `--lib --bins` scope.",
          "timestamp": "2026-06-15T20:32:03+03:00",
          "tree_id": "57231afdd2c93abc833eecb712414335357cd632",
          "url": "https://github.com/murenkov/raznoor.rs/commit/bd55fe09420daa4e7826348f6351c2d93cb3c991"
        },
        "date": 1781545332717,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "53eb9375d5ce62a9273da833d59a82c32b3ce5fe",
          "message": "test: add property-based tests for events, dense output, Jacobian, Newton convergence, and backward integration\n\nAdds 18 proptest functions across 5 categories:\n- Event detection: event_crossing_any_fixed, event_crossing_any_adaptive\n- Dense output consistency: dense_output_erk, dense_output_irk, dense_output_bdf, dense_output_adaptive\n- Jacobian accuracy (unit tests in src/linalg.rs): jacobian_linear_scalar, jacobian_nonlinear_scalar, jacobian_linear_2x2, jacobian_nonlinear_2d\n- Newton convergence: bw_euler, midpoint, cn, radau3, bdf1, bdf2, bdf4\n- Backward integration: erk, irk, bdf, adaptive\n\nAlso fixes clippy suboptimal-flops and items-after-test-module warnings.",
          "timestamp": "2026-06-15T21:13:42+03:00",
          "tree_id": "87bb6854cbadaf92c2421f46e3e995e6ec02b5f5",
          "url": "https://github.com/murenkov/raznoor.rs/commit/53eb9375d5ce62a9273da833d59a82c32b3ce5fe"
        },
        "date": 1781547835527,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "5af47090ee05a32992e6b396997cb0788cfc7774",
          "message": "fix: shorten cargo keyword to meet crates.io limit\n\n`differential-equations` (24 chars) exceeds the 20-char limit for\ncrate keywords on crates.io. Replaced with `numerical-ode` (13 chars).",
          "timestamp": "2026-06-15T21:27:03+03:00",
          "tree_id": "921eac085cb9fc2f691d52c56d1d382f307e5100",
          "url": "https://github.com/murenkov/raznoor.rs/commit/5af47090ee05a32992e6b396997cb0788cfc7774"
        },
        "date": 1781548630845,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "122ff66dd1be381584324fd9a662501f34e103ad",
          "message": "chore: bump version to 0.3.0\n\nAll v0.3 roadmap features are now complete:\n- Stiff solver support (implicit Runge-Kutta, BDF methods)\n- Parallel/rayon-based batched solves\n- Interpolation routines (dense output)\n\nSee ROADMAP.md for details.",
          "timestamp": "2026-06-15T22:10:05+03:00",
          "tree_id": "d9dc31c6e0026fdf26c7786f89ba647992fbecd1",
          "url": "https://github.com/murenkov/raznoor.rs/commit/122ff66dd1be381584324fd9a662501f34e103ad"
        },
        "date": 1781551241581,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "d755aa011e99cb3662352554a499cf5480a8a2fe",
          "message": "chore(deps): bump criterion from 0.5.1 to 0.8.2\n\nBumps [criterion](https://github.com/criterion-rs/criterion.rs) from 0.5.1 to 0.8.2.\n- [Release notes](https://github.com/criterion-rs/criterion.rs/releases)\n- [Changelog](https://github.com/criterion-rs/criterion.rs/blob/master/CHANGELOG.md)\n- [Commits](https://github.com/criterion-rs/criterion.rs/compare/0.5.1...criterion-v0.8.2)\n\n---\nupdated-dependencies:\n- dependency-name: criterion\n  dependency-version: 0.8.2\n  dependency-type: direct:production\n  update-type: version-update:semver-minor\n...\n\nSigned-off-by: dependabot[bot] <support@github.com>",
          "timestamp": "2026-06-16T13:37:30+03:00",
          "tree_id": "177b20232abd430171c030d9d09b2b9eca7a6411",
          "url": "https://github.com/murenkov/raznoor.rs/commit/d755aa011e99cb3662352554a499cf5480a8a2fe"
        },
        "date": 1781606878431,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "616ea71d1176b8fa0c694cfd2bb94eedbb56a36e",
          "message": "feat: extract generate_time_grid into dedicated solver::grid module\n\nMove the uniform time grid generation function from solver::fixed_step\ninto its own solver::grid module so it can be reused by other modules\n(such as the BVP shooting solver) without depending on fixed_step internals.",
          "timestamp": "2026-06-19T23:31:44+03:00",
          "tree_id": "6a357d80a452d1ce6cbd90a605fd18a3f3cb9d1d",
          "url": "https://github.com/murenkov/raznoor.rs/commit/616ea71d1176b8fa0c694cfd2bb94eedbb56a36e"
        },
        "date": 1781901706632,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "d3243254e4ea7455876ce327710321e808deafbe",
          "message": "fix(linalg): relax Jacobian test tolerance for central-difference roundoff\n\nThe tolerance formula `h * h + 1e-10` was too tight for central-difference\nJacobian tests. At small step sizes (h ~ 1.8e-6), roundoff error O(ε/h)\ndominates truncation error O(h^2), giving an expected error of ~2.4e-10\nvs a tolerance of ~1.03e-10.\n\nBump the constant term from 1e-10 to 1e-9 so the tolerance accounts for\nboth truncation and roundoff contributions.",
          "timestamp": "2026-06-20T15:21:38+03:00",
          "tree_id": "36140993a12a1278d16a0c81c9ab4851ff88be55",
          "url": "https://github.com/murenkov/raznoor.rs/commit/d3243254e4ea7455876ce327710321e808deafbe"
        },
        "date": 1781958702233,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "1ab742e530e94c851c72f5e356ab7ee20d5f2c65",
          "message": "feat: add boundary value problem (BVP) solvers via simple shooting\n\nImplement a simple shooting method for solving two-point boundary value\nproblems. The approach converts a BVP into a sequence of IVPs, using\nNewton iteration with a finite-difference Jacobian to satisfy the\nboundary conditions.\n\nNew public API:\n- `BVPProblem<T, F, BC>` - problem definition with ODE RHS, boundary\n  condition function, time span, and initial guess\n- `BVPSolver<T, F, BC>` trait - generic interface for BVP solvers\n- `ShootingSolver<M, T>` - simple shooting implementation wrapping any\n  `ODEMethod` with fixed-step IVP integration\n\nThe inner IVP uses `ODEMethod::step_with_scratch` directly, avoiding\nper-iteration `ODEProblem` allocation. The Jacobian of the boundary\ncondition residual w.r.t. the initial guess is approximated via\nforward finite differences, requiring n+1 IVP solves per Newton\niteration (where n is the number of ODE variables).",
          "timestamp": "2026-06-20T16:54:02+03:00",
          "tree_id": "b11cfc86fbcdb10bb91753e3b5d83760e4313898",
          "url": "https://github.com/murenkov/raznoor.rs/commit/1ab742e530e94c851c72f5e356ab7ee20d5f2c65"
        },
        "date": 1781964254501,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "154dc5487c608c40b9f0db13d0323cdeb31770ce",
          "message": "refactor: reorganize source tree into `ivp/`, `bvp/`, and `types/` modules\n\n- Group IVP method tableaus (ERK, IRK, BDF) under `src/ivp/`\n- Move BVP solver into `src/bvp/shooting.rs` with a `src/bvp/mod.rs`\n- Move `batch.rs` into `src/solver/` (parallel solving belongs with solver infrastructure)\n- Split `src/types.rs` (525 lines) into `src/types/{mod,error,event,solution,problem}.rs`\n- Update `lib.rs` module declarations, doc comment, and re-exports\n- Public API is unchanged; no breaking changes",
          "timestamp": "2026-06-20T18:17:43+03:00",
          "tree_id": "b5ef319ab34871aa22a49fe78b6f102e564abf87",
          "url": "https://github.com/murenkov/raznoor.rs/commit/154dc5487c608c40b9f0db13d0323cdeb31770ce"
        },
        "date": 1781969268790,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "d52a90a7ee6a9898535eab90db6cb443c3e2164c",
          "message": "feat: add forward sensitivity analysis via state augmentation\n\nIntroduce ForwardSensitivityProblem<T, F>, ForwardSensitivitySolver<S>, and ForwardSensitivitySolution<T> that wraps any ODESolver to propagate sensitivities ∂u/∂θ alongside the state.\n\nThe augmented system has dimension n + n×p where n is the state dimension and p is the number of parameters. All Jacobians (∂f/∂u and ∂f/∂p) are computed via central finite differences. Event functions are automatically wrapped to extract the original state from the augmented vector.",
          "timestamp": "2026-06-20T20:22:56+03:00",
          "tree_id": "be5a913e814fc2745b0c85c6484cbb20f0c26bc9",
          "url": "https://github.com/murenkov/raznoor.rs/commit/d52a90a7ee6a9898535eab90db6cb443c3e2164c"
        },
        "date": 1781976799387,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "5b62e9515e1b04d6a1e7c944394d2ace360161dd",
          "message": "ci: add cross-platform test matrix (Windows, macOS)\n\nAdd `os` dimension to CI strategy matrix so tests run on\n`ubuntu-latest`, `windows-latest`, and `macos-latest` instead\nof only Ubuntu. Gate lint/check steps (pre-commit, cargo-machete,\ncargo-deny) to `ubuntu-latest` only to avoid redundant runs and\npotential platform compatibility issues with those tools.\n\nThe `udeps` job remains `ubuntu-latest` only since it requires\nnightly toolchain and the overhead of additional OS targets is\nnot justified for a dependency-unused check.",
          "timestamp": "2026-06-20T21:45:53+03:00",
          "tree_id": "2ce235593fc2917a8e29805feb61cad16da69842",
          "url": "https://github.com/murenkov/raznoor.rs/commit/5b62e9515e1b04d6a1e7c944394d2ace360161dd"
        },
        "date": 1781981757337,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "20a7a6af48362bfb91eb9a97f9f132c23221754f",
          "message": "perf: pre-compute b_diff coefficients in prepare() instead of per-step Vec allocation\n\nMove the `b - b_hat` coefficient computation from\n`step_with_error_with_scratch` (where it allocated a `Vec<f64>` on every\nadaptive step) into `ExplicitRKScratch::prepare()` so it runs once at\nsolver initialisation.\n\nThe new `b_diff: Vec<f64>` field on `ExplicitRKScratch` is populated in\n`prepare()` using the same `zip`/`map` logic that was previously\ninlined in the hot path.",
          "timestamp": "2026-06-20T22:29:17+03:00",
          "tree_id": "52bb811b25c4e74353539d3e7e9cfe37c4116c8e",
          "url": "https://github.com/murenkov/raznoor.rs/commit/20a7a6af48362bfb91eb9a97f9f132c23221754f"
        },
        "date": 1781984365406,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "217a61ad35bb51dd4ebd09ad6a48b2026ef4ed3c",
          "message": "feat!: validate dt sign matches tspan direction\n\nRemove automatic direction recognition from generate_time_grid.\nThe sign of dt now determines integration direction directly,\nand both FixedStepODESolver and AdaptiveODESolver validate at\nsolve-time that sign(dt) == sign(t1 - t0).\n\nBREAKING CHANGE: Backward integration now requires a negative dt\n(e.g. dt = -0.1 with tspan = (1.0, 0.0)). Positive dt with\nbackward tspan is rejected as InvalidStepSize.\n\n- generate_time_grid: validate sign(dt) == sign(t1 - t0) at source\n- FixedStepODESolver::new: reject only dt == 0 (not negative)\n- AdaptiveODESolver::new: same constructor change\n- AdaptiveODESolver::solve: add sign-matching validation\n- BVP shooting: align constructor, propagate error from grid\n- Update all backward integration tests to use negative dt",
          "timestamp": "2026-06-21T10:47:01+03:00",
          "tree_id": "fadf4ab4e696bdb8a8dcf151dd8f40694541a95d",
          "url": "https://github.com/murenkov/raznoor.rs/commit/217a61ad35bb51dd4ebd09ad6a48b2026ef4ed3c"
        },
        "date": 1782028624484,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "eb16b9e2a3dc3e3e1931def4720f2033d87c75cf",
          "message": "docs: add missing `ODESolver` import to README examples\n\nThe first example and the extensibility example in the README called `.solve()`\non a `FixedStepODESolver` without importing the `ODESolver` trait. Without this\nimport, Rust would fail to compile with:\n\n    error[E0599]: no method named `solve` found for struct `FixedStepODESolver`\n\nAdd `ODESolver` to both `use` lines so the examples compile correctly.",
          "timestamp": "2026-06-21T11:17:49+03:00",
          "tree_id": "dd9b31d9a5b1d51a290408179df7179f3ded9644",
          "url": "https://github.com/murenkov/raznoor.rs/commit/eb16b9e2a3dc3e3e1931def4720f2033d87c75cf"
        },
        "date": 1782030469508,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "3567681bfefb2ed6815a5b3672a39e0868370a70",
          "message": "refactor!: remove unused T generic from ExplicitRungeKuttaMethod\n\nThe `ExplicitRungeKuttaMethod<T: 'static>` struct was generic over `T`, but all\nseven pre-defined const instances used `f64`. The type parameter enforced an\nunnecessary `'static` bound and provided no actual flexibility — coefficients\nare always `f64`.\n\nRemove the generic parameter to simplify the public API and all downstream\nsignatures.\n\nChanges:\n- Remove `<T: 'static>` from struct definition\n- Change all field types from `T` to `f64`\n- Remove `<f64>` from all 7 const declarations (RK1–RK5, Fehlberg45,\n  Dormand-Prince45)\n- Remove `<f64>` from `ODEMethod<T>` impl and `compute_stages` fn signature\n- Remove `<f64>` from `FixedStepRK` and `AdaptiveRK` type aliases\n- Remove `<f64>` from `ERKMethod` bench type alias\n\n`f32` and other float-type solves continue to work because the `ODEMethod<T>`\nimpl is generic over `T`, with coefficients converted via `T::from_f64()`.",
          "timestamp": "2026-06-21T11:46:00+03:00",
          "tree_id": "a9a5d725165f45652d4b2d797337187493693cea",
          "url": "https://github.com/murenkov/raznoor.rs/commit/3567681bfefb2ed6815a5b3672a39e0868370a70"
        },
        "date": 1782032176163,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "21e90262591e4445364f37c0cdc96bfbd652f2e2",
          "message": "refactor!: remove unused type parameter from `BDFMethod`\n\n`BDFMethod<T>` carried a `PhantomData<T>` but was always used as\n`BDFMethod<f64>` — all constants (`BDF1`..`BDF6`) and the `ODEMethod`\nimpl were hard-coded to `f64`. Dropping the generic eliminates the\nphantom data and simplifies the type.\n\nBREAKING CHANGE: `BDFMethod` is no longer generic; code referencing\n`BDFMethod<f64>` or `BDFMethod::<f64>::new(...)` must remove the type\nparameter.",
          "timestamp": "2026-06-21T12:47:56+03:00",
          "tree_id": "b4f553d8d8d2fc0514264ba39b5990bae69a81b7",
          "url": "https://github.com/murenkov/raznoor.rs/commit/21e90262591e4445364f37c0cdc96bfbd652f2e2"
        },
        "date": 1782035844025,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "b1bbbe5d7f44e65b8219058b189d0efd64534a19",
          "message": "style: replace `assert!` with `assert_eq!` in sensitivity test\n\n`assert!(states.ncols() == 1)` triggers `clippy::manual_assert_eq`\n(pedantic) since Rust 1.97.0. Use `assert_eq!` instead.",
          "timestamp": "2026-07-10T00:30:20+03:00",
          "tree_id": "2b7c07c5cbec16856a471b8fa2d2e5c68f9ff636",
          "url": "https://github.com/murenkov/raznoor.rs/commit/b1bbbe5d7f44e65b8219058b189d0efd64534a19"
        },
        "date": 1783633265578,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "1eb534505e855e1f047ad3d24d8c69b9a9d2e6df",
          "message": "chore: update Cargo.lock\n\nBump autocfg, bitflags, bumpalo, cc, crossbeam-deque, crossbeam-epoch, and drop unused anyhow dependency.",
          "timestamp": "2026-07-10T00:30:42+03:00",
          "tree_id": "864a0e4ce8e5d481336cfa8200d29e99d22b9ebe",
          "url": "https://github.com/murenkov/raznoor.rs/commit/1eb534505e855e1f047ad3d24d8c69b9a9d2e6df"
        },
        "date": 1783633290560,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "c9b40fadc7bddcdb6a07e4b910798743185656ad",
          "message": "chore(deps): add `rstest` dev dependency\n\nAdd `rstest = \"0.26.1\"` to `[dev-dependencies]` in `Cargo.toml` to\nenable parameterized test rewriting with `#[rstest]` / `#[case]`.",
          "timestamp": "2026-07-10T00:45:02+03:00",
          "tree_id": "aac83dba84842f6095e2f3a0273a005c05c203d7",
          "url": "https://github.com/murenkov/raznoor.rs/commit/c9b40fadc7bddcdb6a07e4b910798743185656ad"
        },
        "date": 1783634136103,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "distinct": true,
          "id": "5e87078fc7f1fbce1eb106241158247118f6c732",
          "message": "test: collapse fixed_step.rs into parameterized rstest functions\n\nReplace near-identical `#[test]` functions with parameterized\n`#[rstest]` functions using `#[case]`:\n\n- `linear_f32` — 7 cases (ERK1–5, Fehlberg45, DOPRI54) with `f32`\n- `linear_f64` — 7 cases (same methods) with `f64`\n- `oscillator_f64` — 7 cases (same methods) with `f64`\n\nEach test body is unchanged; only the method constant is parameterized.",
          "timestamp": "2026-07-10T10:43:24+03:00",
          "tree_id": "ee937d6657a27cb0a6c06e997fad04fedfbddb0c",
          "url": "https://github.com/murenkov/raznoor.rs/commit/5e87078fc7f1fbce1eb106241158247118f6c732"
        },
        "date": 1783670016250,
        "tool": "cargo",
        "benches": [
